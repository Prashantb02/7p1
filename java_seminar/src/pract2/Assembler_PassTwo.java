...
import pract2.Tuple;
import pract2.SymTuple;
import pract2.LitTuple;
	...
	static void initiallizeTables() throws Exception{
		...
		String s;
		BufferedReader br;
		br = new BufferedReader(new InputStreamReader(new FileInputStream("src/pract1/symtable.txt")));
		br.readLine();
		...
		br.close();
		br = new BufferedReader(new InputStreamReader(new FileInputStream("src/pract1/littable.txt")));
		br.readLine();
		while((s = br.readLine()) != null) {
			StringTokenizer st = new StringTokenizer(s, "\t", false);
	...
	static void pass2() throws Exception{
		BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("src/pract1/output_pass1.txt")));
		out_pass2 = new PrintWriter(new FileWriter("src/pract2/output_pass2.txt"), true);
		input.readLine();
		String s;
		out_pass2.println("Name:Prashant Bankar Roll no.22153");
